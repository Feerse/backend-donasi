        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('admin.campaign.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        <label class="text-gray-700" for="name">JUDUL CAMPAIGN<span
                    ...
                    <div>
                        <label class="text-gray-700" for="name">KATEGORI<span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="text-gray-700" for="name">DESKRIPSI<span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="text-gray-700" for="name">TARGET DONASI<span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="text-gray-700" for="name">TANGGAL BERAKHIR<span
                                class="text-red-500">*</span></label>
